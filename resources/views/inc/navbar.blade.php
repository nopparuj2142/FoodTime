                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="{{Request::is('storeslist') ? 'active' : ''}}">
                            <a href="/storeslist" style="padding-left:50px;">
                                <img src="/uploads/icon/store.png" style="width:28px; height:28px; position:absolute; top:10px; left:10px; ">
                                ร้านอาหาร</a>
                        </li>
                        <li class="{{Request::is('foodslist') ? 'active' : ''}}">
                            <a href="/foodslist" style="padding-left:50px;">
                                <img src="/uploads/icon/foods.png" style="width:28px; height:28px; position:absolute; top:10px; left:10px; ">
                                อาหาร</a>
                        </li>
                        <li class="{{Request::is('about') ? 'active' : ''}}">
                            <a href="/about" style="padding-left:50px;">
                                <img src="/uploads/icon/about.png" style="width:28px; height:28px; position:absolute; top:10px; left:10px; ">
                                เกี่ยวกับเรา</a>
                        </li>
                    </ul>
